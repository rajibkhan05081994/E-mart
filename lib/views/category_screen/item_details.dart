            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  10.heightBox,
                  "\$600".text.fontFamily(bold).size(18).color(redColor).make(),
                  10.heightBox,
                  Row(
                    children: [
                      Expanded(
                  ...
                  10.heightBox,
                  "this is dummy items and view".text.color(darkFontGrey).make(),
                  10.heightBox,
                  //buttons sec
                  ListView(
                    ...
                    children: List.generate(
                            5,
                            (index) => ListTile(
                              title: itemDetailsButonList[index].text.fontFamily(semibold).color(darkFontGrey).make(),
                              trailing: const Icon(Icons.arrow_forward),
                            )),
                  ),
                  20.heightBox,
                  productMayLiked.text.fontFamily(bold).color(darkFontGrey).size(16).make(),
                  10.heightBox,
                  //copied from home_screen_main
